<?php
	...
	else
	{
		...
		$strSQL = "INSERT INTO member (Username,Password,Name,Status,stu_id,sit_po,online,login_time,logout_time) VALUES ('".$_POST["txtUsername"]."','".$_POST["txtPassword"]."',
		'".$_POST["txtName"]."','".$_POST["ddlStatus"]."','".$_POST["stu_id"]."','0','0','0000-00-00 00:00:00','0')";
		$objQuery = mysqli_query($objCon,$strSQL);
